...
//
//    playout = findViewById(R.id.layoutId);
//    menu = findViewById(R.id.menu);

/**

    //init the bottom sheet view
    // TODO Bottombar is called here.
     CurvedBottomNavigationView curvedBottomNavigationView = findViewById(R.id.customBottomBar);
     curvedBottomNavigationView.setOnClickListener(new View.OnClickListener() {
       @Override
 ...
 **/
    ...
    /**
     * TODO for animating it.
//    menu.setOnClickListener(new View.OnClickListener() {
//      @Override
//      public void onClick(View v) {
//        if(isInflated) {
//          animateinflateLayout(200);
//          isInflated=false;
//        }
//        else
//        {
//          animateinflateLayout( 1000);
//          isInflated=true;
//        }
//      }
//    });
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(final MapboxMap mapboxMap) {
        ...
        customThemeManager = new CustomThemeManager(chosenTheme, MainActivity.this);
        ...
        mapboxMap.setStyle(Style.LIGHT, new Style.OnStyleLoaded() {
          ...
          public void onStyleLoaded(@NonNull Style style) {
            ...
            if (featureList != null) {
              ...
              Toast.makeText(MainActivity.this, "Click on a card", Toast.LENGTH_SHORT).show();
...
//              }
  ...
  public void animateinflateLayout(int pi){

    pwidthAnimator = ValueAnimator.ofInt(playout.getHeight(), pi);
    pwidthAnimator.setDuration(1000);
    pwidthAnimator.setInterpolator(new AnticipateOvershootInterpolator());
    pwidthAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      @Override
      public void onAnimationUpdate(ValueAnimator animation) {
        playout.getLayoutParams().height = (int) animation.getAnimatedValue();
        playout.requestLayout();
      }
    });
    pwidthAnimator.addListener(new Animator.AnimatorListener() {
      @Override
  ...
  private void getInformationFromDirectionsApi(Point destinationPoint,
    ...
    directionsApiClient.enqueueCall(new Callback<DirectionsResponse>() {
      ...
      public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
        Toast.makeText(MainActivity.this, R.string.failure_to_retrieve, Toast.LENGTH_LONG).show();
      }
    });
  }
